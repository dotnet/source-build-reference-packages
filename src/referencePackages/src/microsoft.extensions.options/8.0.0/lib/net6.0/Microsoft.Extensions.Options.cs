...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static Options.OptionsBuilder<TOptions> ValidateOnStart<TOptions>(this Options.OptionsBuilder<TOptions> optionsBuilder)
    ...
    public static partial class OptionsServiceCollectionExtensions
    {
        ...
        public static Options.OptionsBuilder<TOptions> AddOptionsWithValidateOnStart<TOptions>(this IServiceCollection services, string? name = null)
            where TOptions : class { throw null; }

        public static Options.OptionsBuilder<TOptions> AddOptionsWithValidateOnStart<TOptions, TValidateOptions>(this IServiceCollection services, string? name = null)
            where TOptions : class where TValidateOptions : class, Options.IValidateOptions<TOptions> { throw null; }
