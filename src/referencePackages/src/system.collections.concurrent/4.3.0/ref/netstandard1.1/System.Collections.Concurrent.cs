...
{
    public partial class BlockingCollection<T> : ICollection, IEnumerable, IDisposable
    {
    ...
    public partial class ConcurrentBag<T> : ICollection, IEnumerable
    {
    ...
    public partial class ConcurrentDictionary<TKey, TValue> : Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable
    {
    ...
    public partial class ConcurrentQueue<T> : ICollection, IEnumerable
    {
    ...
    public partial class ConcurrentStack<T> : ICollection, IEnumerable
    {
    ...
    public partial interface IProducerConsumerCollection<T> : ICollection, IEnumerable
    {
