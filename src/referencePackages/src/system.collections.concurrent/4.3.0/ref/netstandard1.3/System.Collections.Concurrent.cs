...
{
    public partial class BlockingCollection<T> : IEnumerable, ICollection, IDisposable
    {
    ...
    public partial class ConcurrentBag<T> : IEnumerable, ICollection
    {
    ...
    public partial class ConcurrentDictionary<TKey, TValue> : Generic.ICollection<Generic.KeyValuePair<TKey, TValue>>, Generic.IEnumerable<Generic.KeyValuePair<TKey, TValue>>, IEnumerable, Generic.IReadOnlyCollection<Generic.KeyValuePair<TKey, TValue>>, ICollection, IDictionary
    {
    ...
    public partial class ConcurrentQueue<T> : IEnumerable, ICollection
    {
    ...
    public partial class ConcurrentStack<T> : IEnumerable, ICollection
    {
    ...
    public partial interface IProducerConsumerCollection<T> : IEnumerable, ICollection
    {
