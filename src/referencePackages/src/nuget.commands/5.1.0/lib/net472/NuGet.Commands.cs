...
namespace NuGet.Commands
{
    ...
    public sealed partial class TrustedSignerActionsProvider
    {
        ...
        public System.Threading.Tasks.Task AddTrustedSignerAsync(string name, NuGet.Packaging.Signing.ISignedPackageReader package, NuGet.Packaging.Signing.VerificationTarget trustTarget, bool allowUntrustedRoot, System.Collections.Generic.IEnumerable<string> owners, System.Threading.CancellationToken token) { throw null; }
...
namespace NuGet.Commands.SignCommand
{
    ...
    {
        System.Threading.Tasks.Task<System.Security.SecureString> GetPassword(string filePath, System.Threading.CancellationToken token);
    }
}
