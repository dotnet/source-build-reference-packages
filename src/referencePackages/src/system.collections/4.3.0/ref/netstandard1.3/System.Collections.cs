...
{
    public abstract partial class Comparer<T> : IComparer
    {
        protected Comparer() { }
    ...
    public partial class Dictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IReadOnlyCollection<KeyValuePair<TKey, TValue>>, ICollection, IDictionary
    {
        public Dictionary() { }
        ...
        public sealed partial class KeyCollection : IEnumerable, ICollection
        {
        ...
        public sealed partial class ValueCollection : IEnumerable, ICollection
        {
    ...
    public abstract partial class EqualityComparer<T> : IEqualityComparer
    {
    ...
    public partial class HashSet<T> : IEnumerable
    {
        public HashSet() { }
    ...
    public partial class LinkedList<T> : IEnumerable, ICollection
    {
        public LinkedList() { }
    ...
    public partial class List<T> : IEnumerable, ICollection, IList
    {
        public List() { }
    ...
    public partial class Queue<T> : IEnumerable, ICollection
    {
        public Queue() { }
    ...
    public partial class SortedDictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IReadOnlyCollection<KeyValuePair<TKey, TValue>>, ICollection, IDictionary
    {
    ...
    public partial class SortedList<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IReadOnlyCollection<KeyValuePair<TKey, TValue>>, ICollection, IDictionary
    {
        public SortedList() { }
    ...
    public partial class SortedSet<T> : IEnumerable, ICollection
    {
        public SortedSet() { }
    ...
    public partial class Stack<T> : IEnumerable, ICollection
    {
        public Stack() { }
