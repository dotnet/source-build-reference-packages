...
namespace System.Collections.Generic
{
    ...
    public partial class Dictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IReadOnlyCollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable
    {
        public Dictionary() { }
        ...
        public sealed partial class KeyCollection : ICollection, IEnumerable
        {
        ...
        public sealed partial class ValueCollection : ICollection, IEnumerable
        {
    ...
    public partial class LinkedList<T> : ICollection, IEnumerable
    {
        public LinkedList() { }
    ...
    public partial class List<T> : IList, ICollection, IEnumerable
    {
        public List() { }
    ...
    public partial class Queue<T> : ICollection, IEnumerable
    {
        public Queue() { }
    ...
    public partial class SortedDictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IDictionary, ICollection, IEnumerable
    {
    ...
    public partial class SortedSet<T> : ICollection, IEnumerable
    {
        public SortedSet() { }
    ...
    public partial class Stack<T> : ICollection, IEnumerable
    {
        public Stack() { }
