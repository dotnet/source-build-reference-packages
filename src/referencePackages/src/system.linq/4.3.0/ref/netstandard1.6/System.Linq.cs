...
namespace System.Linq
{
    ...
    public partial interface IGrouping<out TKey, out TElement> : Collections.IEnumerable
    {
        TKey Key { get; }
    }
    ...
    public partial interface IOrderedEnumerable<TElement> : Collections.IEnumerable
    {
    ...
    public partial class Lookup<TKey, TElement> : Collections.Generic.IEnumerable<IGrouping<TKey, TElement>>, Collections.IEnumerable
    {
