...
namespace System
{
    ...
    public abstract partial class Array : Collections.ICollection, Collections.IEnumerable, Collections.IList, Collections.IStructuralComparable, Collections.IStructuralEquatable
    {
        ...
        Object Collections.IList.get_Item(Int32 index) { throw null; }
        ...
        void Collections.IList.set_Item(Int32 index, Object value) { }
    ...
    public partial struct ArraySegment<T> : Collections.IEnumerable
    {
        ...
        T Collections.Generic.IList<T>.Item { get { throw null; } set { } }

        T Collections.Generic.IReadOnlyList<T>.Item { get { throw null; } }
    ...
    public partial struct Double : IComparable, IComparable<Double>, IConvertible, IEquatable<Double>, IFormattable
    {
        ...
        public const Double MaxValue = MaxValue;
        public const Double MinValue = MinValue;
        public const Double NaN = NaN;
        public const Double NegativeInfinity = NegativeInfinity;
        public const Double PositiveInfinity = PositiveInfinity;
    ...
    {
        public const Int16 MaxValue = MaxValue;
        public const Int16 MinValue = MinValue;
    ...
    {
        public const Int32 MaxValue = MaxValue;
        public const Int32 MinValue = MinValue;
    ...
    {
        public const Int64 MaxValue = MaxValue;
        public const Int64 MinValue = MinValue;
    ...
    {
        public const SByte MaxValue = MaxValue;
        public const SByte MinValue = MinValue;
    ...
    {
        public const Single Epsilon = Epsilon;
        public const Single MaxValue = MaxValue;
        public const Single MinValue = MinValue;
        public const Single NaN = NaN;
        public const Single NegativeInfinity = NegativeInfinity;
        public const Single PositiveInfinity = PositiveInfinity;
    ...
    {
        public const UInt16 MaxValue = MaxValue;
    ...
    {
        public const UInt64 MaxValue = MaxValue;
...
{
    public partial interface ICollection<T> : IEnumerable
    {
        Int32 Count { get; }
    ...
    public partial interface IList<T> : IEnumerable
    {
    ...
    public partial interface IReadOnlyCollection<out T> : IEnumerable
    {
        Int32 Count { get; }
    }
    ...
    public partial interface IReadOnlyList<out T> : IEnumerable
    {
        T this[Int32 index] { get; }
    }

    public partial interface ISet<T> : IEnumerable
    {
        Boolean Add(T item);
...
{
    public partial class Collection<T> : IEnumerable, ICollection, IList
    {
        public Collection() { }
        ...
        Object IList.get_Item(Int32 index) { throw null; }
        ...
        void IList.set_Item(Int32 index, Object value) { }
    }

    public partial class ReadOnlyCollection<T> : IEnumerable, ICollection, IList
    {
