...
"$scriptroot/eng/common/build.sh" --build --restore -bl /p:GeneratePackageSource=true /p:GeneratorVersion=1 $@
...
echo -e "  Additions to be made to ${GREEN}$pathToRepoSrc/ProjectsToBuild.props${NC} are here: ${GREEN}$pathToGeneratedSrc/ProjectsToBuildAdditions.txt${NC}"
echo -e "  These additions must be made manually.  Note: Some of the projects listed may already be included"
echo
